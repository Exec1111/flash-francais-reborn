...
def seed_reference_data(db: Session):
    ...
    {'key': 'TEXTERECONSTITUE', 'parent_type_key': 'EXERCICE', 'value': 'Reconstitution de texte'},
    ...
    {'key': 'INTROSEQUENCE', 'parent_type_key': 'LECON', 'value': 'Introduction de séquence'},
    {'key': 'FICHEMETHODE', 'parent_type_key': 'LECON', 'value': 'Fiche méthodologique'},
    {'key': 'CARTEMENTAL', 'parent_type_key': 'LECON', 'value': 'Carte mentale'},
